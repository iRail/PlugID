...
class Service_instagram extends Service_driver {
    
    private $oauth, $access_token;
    private $url_authorize = 'https://api.instagram.com/oauth/authorize';
    private $url_access_token = 'https://api.instagram.com/oauth/access_token';
    private $url_base = 'https://api.instagram.com/v1/';
    ...
    function callback($data) {
    	$error_message = 'Error authenticating with Instagram. Please try again later. Technical detail for our monkeys: ';
        // check code
        if (!isset($data['code'])) {
